...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 33 = access	*/
	do_get,		/* 34 = getgroups */
	do_halt_recover,		/* 35 = mailbox HaltRecover	*/
	no_sys,		/* 36 = sync	*/
	do_kill,	/* 37 = kill	*/
	no_sys,		/* 38 = rename	*/
	no_sys,		/* 39 = mkdir	*/
	...
	no_sys,		/* 54 = ioctl	*/
	no_sys,		/* 55 = fcntl	*/
	do_mgarbage,		/* 56 = mailbox garbage	*/
	no_sys,		/* 57 = unused	*/
	do_mcreate,		/* 58 = mailbox-Create	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	do_set,		/* 62 = setsid	*/
	...
	do_usrsend,		/* 69 = usrsend	*/
	do_usrrecive,	/* 70 = usrrecive */
	...
	no_sys,		/* 95 = (fchmod) */
	no_sys,		/* 96 = (fchown) */
	do_changep,		/* 97 = Mailbox Change permisssion */
	...
	do_msearch,		/* 103 = Mailbox searching Function */
	do_getprocnr,	/* 104 = getprocnr */
	do_remuser,		/* 105 = mailbox Remove User */
	do_get,		/* 106 = issetugid */
	do_getepinfo_o,	/* 107 = getepinfo XXX: old implementation*/
	do_msender,		/* 108 = msender */
	do_mreciver,		/* 109 = mreciver */
	do_denyaccess,		/* 110 = mailbox deny access */
