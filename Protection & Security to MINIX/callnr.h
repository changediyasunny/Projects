...
#define ACCESS		  33 
#define GETGROUPS	  34
#define HALT_RECOVER  35  /*Mailbox HAlt Recover...*/
#define SYNC		  36 
#define KILL		  37
#define RENAME		  38
#define MKDIR		  39
...
#define USRSEND       69 /*mailbox send call*/
#define USRRECIVE     70 /*mailbox receive call*/
...
#define MINIT         79  /*mailbox init call*/
...
#define CHANGEP       97    /*Mailbox Change permission*/
...
#define MSEARCH     103 /*Mailbox Search Call*/
#define GETPROCNR	104	/* to PM */
#define ISSETUGID	106	/* to PM: ask if process is tainted */
#define REMUSER     105 /* Mailbox User remove....*/
#define GETEPINFO_O	107	/* to PM: get pid/uid/gid of an endpoint */

#define MSENDER     108  /*mailbox sender register*/
#define MRECIVER    109  /*mailbox receiver register*/
#define DENYACCESS  110  /*Mailbox Deny Access*/
